...
export const products: Product[] = [
  ...
  {
    id: "electronics-1",
    title: "Mixed Electronics Pallets – 200 Units Available",
    shortDescription: "200 mixed electronics pallets at $800 each – great value for resellers!",
    fullDescription: "We currently have 200 mixed electronics pallets available for immediate purchase at $800 each. These pallets contain a variety of electronic items including smart watches, headphones, speakers, kitchen gadgets, chargers, and more. Ideal for resellers and liquidation buyers looking for great value. 📦 Don't miss out on this opportunity! Contact us today to secure your stock.",
    price: "$800",
    mainImage: "/src/assets/electronics-pallet-1.jpeg",
    gallery: [
      "/src/assets/electronics-pallet-2.jpeg",
      "/src/assets/electronics-pallet-3.jpeg",
      "/src/assets/electronics-pallet-4.jpeg",
      "/src/assets/electronics-pallet-5.jpeg",
      "/src/assets/electronics-pallet-6.jpeg",
    ],
    category: "electronics",
    condition: "Mixed",
    itemsPerPallet: "200 pallets available",
    orderLink: "https://wa.me/1234567890",
  },
  {
    id: "electronics-2",
    title: "Mixed Electronics Pallet - Lot B",
    shortDescription: "Variety of consumer electronics and gadgets",
    fullDescription: "Another selection from our 200 mixed electronics pallets. Features smart watches, Bluetooth devices, small appliances, portable speakers, and various tech accessories. Perfect for flea markets, online selling, and retail stores. Contact us today to secure your stock!",
    price: "$800",
    mainImage: "/src/assets/electronics-pallet-7.jpeg",
    gallery: [
      "/src/assets/electronics-pallet-8.jpeg",
      "/src/assets/electronics-pallet-9.jpeg",
      "/src/assets/electronics-pallet-10.jpeg",
      "/src/assets/electronics-pallet-1.jpeg",
      "/src/assets/electronics-pallet-2.jpeg",
    ],
    category: "electronics",
    condition: "Mixed",
