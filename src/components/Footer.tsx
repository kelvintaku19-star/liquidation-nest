          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-primary-foreground/80">Palletliquidation764@gmail.com</span>
              </div>
              <a 
                href="https://wa.me/61489979358" 
                target="_blank" 
              ...
              >
                ...
                <span className="text-primary-foreground/80">WhatsApp: +61 489 979 358</span>
              </a>
              <a 
              ...
              >
                ...
                <span className="text-primary-foreground/80">Telegram Channel</span>
              </a>
              <div className="flex items-center gap-3">
